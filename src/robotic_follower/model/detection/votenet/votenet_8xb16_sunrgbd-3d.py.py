...
model = dict(
    backbone=dict(
        ...
        sa_cfg=dict(
            normalize_xyz=True, pool_mod="max", type="PointSAModule", use_xyz=True
        ),
        sa_channels=(
            (
                64,
    ...
    bbox_head=dict(
        ...
        dir_res_loss=dict(loss_weight=10.0, reduction="sum", type="mmdet.SmoothL1Loss"),
        num_classes=10,
        ...
        size_res_loss=dict(
            loss_weight=3.3333333333333335, reduction="sum", type="mmdet.SmoothL1Loss"
        ),
        type="VoteHead",
    ...
    test_cfg=dict(
        nms_thr=0.25, per_class_proposal=True, sample_mode="seed", score_thr=0.05
    ),
    train_cfg=dict(neg_distance_thr=0.6, pos_distance_thr=0.3, sample_mode="vote"),
    type="VoteNet",
)
optim_wrapper = dict(
